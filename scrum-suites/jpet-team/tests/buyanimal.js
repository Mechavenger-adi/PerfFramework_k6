...
export default function () {
  ...
  group("t02_login", function () {
    ...
    const request_3 = {
      ...
      variableEvents: [
        { name: "p_username", type: "parameter", action: 'used', value: String(getUniqueItem(FILES["userdetails"])["p_username"] ?? ''), source: "body" },
        { name: "p_password", type: "parameter", action: 'used', value: String(getUniqueItem(FILES["userdetails"])["p_password"] ?? ''), source: "body" }
      ],
      params: {
        ...params,
        tags: {
