...
export type ExecutorType = 'ramping-vus' | 'constant-vus' | 'ramping-arrival-rate' | 'constant-arrival-rate' | 'shared-iterations' | 'per-vu-iterations' | 'externally-controlled';
