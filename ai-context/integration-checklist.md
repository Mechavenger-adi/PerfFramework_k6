...
- [ ] Define TypeScript interfaces in `core-engine/src/types/`
...
- [ ] Export from `core-engine/src/index.ts` if it's part of the public API

### 4. CLI Wiring
- [ ] Register command/option in `core-engine/src/cli/run.ts`
...
- [ ] Update `ai-context/` affected files
