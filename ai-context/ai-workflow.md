...
1. Read `ai-context/overview.md` — understand scope and loading strategy
...
3. Update affected `ai-context/` files if architecture changed
4. Test manually: existing CLI commands + new feature

## Token-Saving Tips

- Don't read AGENT-CONTEXT.md (1841 lines). Use ai-context/ files instead.
