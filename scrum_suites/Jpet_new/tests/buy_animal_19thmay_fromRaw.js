...
export function actionPhase(ctx) {
  ...
  group("t02_login", function () {
      ...
      const request_1 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "GET",
        url: `${env.baseUrl}/account/signonForm`,
        body: null,
        params: {
          headers: {
            accept: `text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7`,
      ...
      const request_3 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "POST",
        url: `${env.baseUrl}/account/signon`,
        body: JSON.parse(
  ...
  group("search_animal", function () {
      ...
      const request_1 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "GET",
        url: `${env.baseUrl}/catalog/searchProducts?keyword=${getUniqueItem(FILES["pet"])["p_pet"]}`,
        body: null,
        params: {
          headers: {
            "sec-ch-ua": `"Chromium";v="146", "Not-A.Brand";v="24", "Google Chrome";v="146"`,
  ...
  group("select product", function () {
      ...
      const request_1 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "GET",
        url: `${env.baseUrl}/products/${correlation_vars["correlation_0"]}`,
        body: null,
        params: {
          headers: {
            accept: `text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7`,
  ...
  group("add to cart", function () {
      ...
      const request_1 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "GET",
        url: `${env.baseUrl}/cart/addItemToCart?itemId=EST-6`,
        body: null,
        params: {
          headers: {
            accept: `text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7`,
  ...
  group("increase quantity to 2 and proceed to checkout", function () {
      ...
      const request_1 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "POST",
        url: `${env.baseUrl}/cart/updateCartQuantities`,
      ...
      const request_2 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "GET",
        url: `${env.baseUrl}/order/newOrderForm`,
        body: null,
        params: {
          headers: {
            accept: `text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7`,
  ...
  group("click continue", function () {
      ...
      const request_1 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "POST",
        url: `${env.baseUrl}/order/newOrder`,
        body: JSON.parse(
  ...
  group("click confirm", function () {
      ...
      const request_1 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "POST",
        url: `${env.baseUrl}/order/submitOrder`,
      ...
      const request_2 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "GET",
        url: `${env.baseUrl}/order/viewOrder?orderId=${correlation_vars["correlation_1"]}&submitted=true`,
        body: null,
        params: {
          headers: {
            "cache-control": `max-age=0`,
  ...
  group("logout", function () {
      ...
      const request_1 = {
        ...
        recordingStartedAt: new Date().toISOString(),
        method: "GET",
        url: `${env.baseUrl}/account/signoff`,
        body: null,
        params: {
          headers: {
            accept: `text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7`,
