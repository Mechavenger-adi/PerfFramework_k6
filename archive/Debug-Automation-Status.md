...
- Verified end-to-end debug execution with a real k6 run from `config/test_plans/debug_test.json`, producing both replay-log JSON and HTML diff output successfully.
