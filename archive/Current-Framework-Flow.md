...
flowchart TD
    ...
    INIT --> INIT_SCAFFOLD[Scaffold config, testSuites, sample files]
...
flowchart TD
    ...
    GEN_SCRIPT --> SCRIPT_FILE[testSuites/team/tests/generated-script.js]
    GEN_REC_LOG --> REC_FILE[testSuites/team/recordings/generated-script.recording-log.json]
```
