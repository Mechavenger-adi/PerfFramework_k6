...
export function actionPhase(ctx) {
  ...
  transaction('search_animal', function() {
      ...
      if (match) {
        correlation_vars["correlation_0"] = match[1]; //trackCorrelation("correlation_0", match[1], "body");
      }
    });
  ...
  transaction('click_confirm', function() {
      ...
      if (match) {
        correlation_vars["correlation_1"] = match[1];//trackCorrelation("correlation_1", match[1], "body");
      }
