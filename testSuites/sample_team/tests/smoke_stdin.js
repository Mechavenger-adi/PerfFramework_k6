...
export function actionPhase(ctx) {
  transaction('transaction_1', function () {
    const res1 = request('POST', `${env.baseUrl}/anything?foo=bar`, {
      headers: {
      accept: "*/*",
      "accept-language": "en-US,en;q=0.9",
      "content-type": "application/json",
      Cookie: "session=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.foo.bar; tracking={\"id\":42,\"q\":\"a%27b\"}; rt=ABCDE",
    },
      body: "{\"event\":\"PV\",\"t\":1779868838989}",
      replay: {
        id: "req_1",
