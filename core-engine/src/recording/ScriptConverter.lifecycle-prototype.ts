...
export class ScriptConverter {
  ...
  private static renderLifecycleHeader(lifecycle: LifecycleConfig): string {
  ...
  private static renderLifecycleDefault(): string {
  ...
  private static replaceStateDataRefs(statement: string, mappings: Map<string, string>): string {
