...
export class ScriptGenerator {
  ...
  private static renderLegacyDefault(groups: TransactionGroup[]): string {
  ...
  private static renderPhaseFunction(name: string, groups: TransactionGroup[]): string {
  ...
  private static renderGroups(groups: TransactionGroup[], baseIndent: number): string {
    let script = '';
  ...
  private static renderLifecycleHelpers(): string {
  ...
  private static partitionGroups(
    ...
    lifecycle: LifecycleConfig,
  ): { init: TransactionGroup[]; action: TransactionGroup[]; end: TransactionGroup[] } {
  ...
  private static buildHttpCall(method: string, requestName: string, responseName: string): string {
    if (method === 'GET') {
